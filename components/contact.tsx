        ...
        >
          ...
          {submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                className="mt-2 w-full rounded-lg bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition-all duration-200 hover:bg-primary/90 hover:shadow-[0_0_16px_rgba(123,45,62,0.3)]"
              >
                Send Message
              </button>
            </form>
